        ...
        <>
            <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                <div className="flex items-center justify-between">
                    ...
                    {activeTab === "office" && <AddDialog title="Office"><AddOfficeForm /></AddDialog>}
                    {activeTab === "division" && <AddDialog title="Division"><AddDivisionForm group={{ office }} /></AddDialog>}
                    {activeTab === "unit" && <AddDialog title="Unit"><AddUnitForm group={{ office, division }} /></AddDialog>}
                </div>
                <div className="grid auto-rows-min gap-4 md:grid-cols-1">
                    <div className="table-container">
                        <Tabs defaultValue="office" onValueChange={(value) => setActiveTab(value)}>
                            <TabsList>
                            ...
                            <TabsContent value="office">
                                <DataTable columns={OfficeColumns} data={office} />
                            </TabsContent>
